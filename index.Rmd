...
Tulemused näitavad, et SKT kasv ja inflatsioon on statistiliselt olulised. Samuti kasvas mudeli seletusvõime 27%ni (*Adjusted R-squared*) ning mudel ise on statistiliselt oluline.
...
```{r}
mlr_mudel_2 = lm(support ~ unemp + gdpgr_yearly + inflats_a + party, data=df)
summary(mlr_mudel_2)
