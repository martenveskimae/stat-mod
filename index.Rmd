...
RK_2015$vote = factor(RK_2015$vote,levels=voted)
RK_2015$wage = factor(RK_2015$wage,levels=wages)
RK_2015$education = factor(RK_2015$education,levels=edu)
...
Rohkem võimalusi **interploti** kohta leiab siit: <a href="https://cran.r-project.org/web/packages/interplot/vignettes/interplot-vignette.html">interplot: Plot the Effects of Variables in Interaction Terms</a>
</div>
